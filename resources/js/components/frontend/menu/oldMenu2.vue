                                                      ...
                                                      <div class="modal-content modal_content">
                                                          ...
                                                          <div class="modal-body">
                                                                      ...
                                                                      <div class="row">
                                                                          <div class="col-sm-4 col-4">
                                                                              <div class="sm_cart_image">
                                                                                  <img src="/images/dulux_images/paint-1.png" alt="" srcset="">
                                                                              </div>
                                                                          </div>
                                                                          <div class="col-sm-8 col-8">
                                                                              ...
                                                                              <div class="addon_detail">
                                                                                  Size: 5 Litres | 3 Quantities
                                                                              </div>

                                                                              <div class="addon_detail">
                                                                                  Addon: Brush | 1 Quantity | $20
                                                                              </div>
                                                              ...
                                                              <div class="cart_lg_row">
                                                                  ...
                                                                  <div class="row" v-for="(cart, index) in carts" :key="index">
                                                                    <div class="cart_row">
                                                                      ...
                                                                      <div class="col-md-2 col-sm-2">
                                                                          ...
                                                                          <div class="cart_color" style="background-color:blue">
                                                                                  ...
                                                                                  <div>
                                                                                      <div id="accordion" class="accordion cart_accordion">
                                                                                          <div class="addon_container mb-0">
                                                                                              ...
                                                                                              <div :id="'collapse-'+index" class="card-body collapse addon_background"
                                                                                          ...
                                                                                          <div class="addon_container mb-0">
                                                                                              ...
                                                                                              <div :id="'collapseTwo-'+index" class="card-body collapse addon_background"
                                                                                                  data-parent="#accordion">
                                                                                                  <table class="table">
                                                                                                      <thead>
                                                                                                          <tr>
                                                                  ...
                                                                  <div class="total bg-info" style="margin-top:-20px" v-show="carts">
