<div>
    ...
    <div class="banner-area bg_cover d-flex align-items-center" id="videoHome" style="background-image: url({{$be->hero_bg ? asset('assets/front/img/'.$be->hero_bg) : ''}})">
        <div id="bgndVideo" data-property="{videoURL:'{{$be->hero_section_video_link}}',containment:'#videoHome', quality:'large', autoPlay:true, loop:true, mute:true, opacity:1}"></div>
        <div class="container">
            <div class="row">
        ...
        <div class="banner-thumb d-none d-md-block">
            <img src="{{asset('assets/front/img/'.$be->hero_side_img)}}" alt="banner">
        </div>
        @endif
    </div>
