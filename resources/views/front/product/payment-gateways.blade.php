...
<div class="row gateway-details" id="tab-stripe">
    ...
    <div class="col-md-6">
        ...
        <div class="field-input">
            <input type="text" class="card-elements mb-0" name="cardNumber" placeholder="{{ __('Card Number')}}" autocomplete="off" />
        </div>
        @error('cardNumber')
    ...
    <div class="col-md-6">
        ...
        <div class="field-input">
            <input type="text" class="card-elements mb-0" placeholder="{{ __('CVC') }}" name="cardCVC">
        </div>
        @error('cardCVC')
        <p class="text-danger">{{convertUtf8($message)}}</p>
        @enderror
    ...
    <div class="col-md-6 mb-4">
        ...
        <div class="field-input">
            <input type="text" class="card-elements mb-0" placeholder="{{__('Month')}}" name="month">
        </div>
        @error('month')
        <p class="text-danger">{{convertUtf8($message)}}</p>
        @enderror
    ...
    <div class="col-md-6 mb-4">
        ...
        <div class="field-input">
            <input type="text" class="card-elements mb-0" placeholder="{{__('Year')}}" name="year">
        </div>
        @error('year')
        <p class="text-danger">{{convertUtf8($message)}}</p>
        @enderror
...
<div class="row gateway-details" id="tab-payumoney">
    ...
    <div class="col-lg-6 mb-4">
        <div class="field-input">
            <input class="card-elements mb-0" name="payumoney_first_name" type="text" placeholder="{{ __('First Name') }}" />
        </div>
    ...
    <div class="col-lg-6 mb-4">
        <div class="field-input">
            <input class="card-elements mb-0" name="payumoney_last_name" type="text" placeholder="{{ __('Last Name') }}" />
        </div>
    ...
    <div class="col-lg-6 mb-4">
        <div class="field-input">
            <input class="card-elements mb-0" name="payumoney_phone" type="text" placeholder="{{ __('Phone') }}"  />
        </div>
