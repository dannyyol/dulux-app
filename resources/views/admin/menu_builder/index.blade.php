                    ...
                    <div class="card border-primary mb-3">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">{{__('Menu 1')}} <a data-text="{{__('Menu 1')}}" data-type="menu_1" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                <li class="list-group-item">{{__('Menu 2')}} <a data-text="{{__('Menu 2')}}" data-type="menu_2" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                <li class="list-group-item">{{__('Items')}} <a data-text="{{__('Items')}}" data-type="items" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                ...
                                <li class="list-group-item">{{__('Blogs')}} <a data-text="{{__('Blogs')}}" data-type="blogs" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                ...
                                <li class="list-group-item">{{__('Reservation')}} <a data-text="{{__('Reservation')}}" data-type="reservation" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
