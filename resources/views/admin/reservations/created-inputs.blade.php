...
{{-- input type text --}}
@if ($input->type == 1)
<form action="{{route('admin.reservation.inputDelete')}}" method="post">
    {{csrf_field()}}
    ...
    <div class="row">
        ...
        <div class="col-md-1">
        <a class="btn btn-warning btn-md" href="{{route('admin.reservation.inputEdit', $input->id) . '?language=' . request()->input('language')}}">
...
<form action="{{route('admin.reservation.inputDelete')}}" method="post">
    ...
    <div class="row">
        <div class="col-md-10">
        <input class="form-control" type="number" name="" value="" placeholder="{{$input->placeholder}}">
        </div>
        <div class="col-md-1">
        <a class="btn btn-warning btn-md" href="{{route('admin.reservation.inputEdit', $input->id) . '?language=' . request()->input('language')}}">
            <i class="fas fa-edit"></i>
