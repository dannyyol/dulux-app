          ...
          <div class="card-title">
              <div class="row">
                  ...
                  <div class="col-lg-6 text-right">
                    <a class="btn btn-primary" href="{{route('admin.reservation.form') . '?language=' . request()->input('language')}}">Back</a>
                  </div>
              </div>
          </div>
        </div>
        ...
        <div class="card-body">
            <div class="row" id="app">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form id="ajaxForm" action="{{route('admin.reservation.inputUpdate')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label for=""><strong>Order Number</strong></label>
                            <div class="">
                                <input type="text" class="form-control" name="order_number" value="{{$input->order_number}}" placeholder="Enter Placeholder">
                            </div>
                            <p id="errorder_number" class="mb-0 text-danger em"></p>
                        </div>
...
@section('vuescripts')
  <script>
    var app = new Vue({
      ...
      created() {
        $.get("{{route('admin.reservation.options', $input->id)}}", (data) => {
