...
@section('body')
@includeIf('frontend.partials.__style2')
        ...
        <div class="region region-content focus-outline">
            <div id="full-form-wrapper" class="focus-outline">
                <form class="flourish-colors-listing form-counter focus-outline"
                    ...
                    <div class="focus-outline"><button style="display:none" id="edit-filters-reset-link--2"
                                                            ...
                                                            <div class="carousel-inner">
                                                                <div class="carousel-item active">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a class="color-box-child  color-box-child-1190594 colorBox-processed flourish_google_tag_manager-processed"  data-toggle="modal" data-target="#exampleModalCenter"
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="background:#F4F0E4"
>
      ...
      <div class="modal-footer  border-0">
        ...
        <div class="" style="float: right !important;">
            ...
            <a href="{{ url("/home") }}" class="btn btn-light">I'd like to find a product in this colour</a>
        </div>
