...
// Route::get('/api/{vue_capture?}', function(){
//     return view('frontend.index');
// })->where('vue_capture', '[\/\w\.-]*');

Route::get('/api/{vue_capture?}', "Front\FrontendController@index")->where('vue_capture', '[\/\w\.-]*');
...
Route::middleware(['setlang'])->group(function () {
    ...
    Route::get('/home', 'Front\FrontendController@home');
    // Route::get('/color', 'Front\FrontendController@color');
    // Route::get('/color', 'Front\FrontendController@color');
    Route::post('/save/review', 'Front\CustomerreviewController@store');
...
Route::get('/qr-menu', 'Front\FrontendController@qrMenu')->name('front.qrmenu');
Route::get('/changelanguage/{lang}', 'Front\FrontendController@changeLanguage')->name('changeLanguage');
...
Route::get('/product/payment/notify', 'Payment\product\PaypalController@notify')->name('product.payment.notify');
// paypal routes
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Order Management'], function () {
        ...
        Route::get('/product/received/orders', 'Admin\ProductOrderController@received')->name('admin.received.product.orders');
        Route::get('/product/preparing/orders', 'Admin\ProductOrderController@preparing')->name('admin.preparing.product.orders');
        Route::get('/product/ready-to-pickup/orders', 'Admin\ProductOrderController@readyToPickup')->name('admin.readyToPickup.product.orders');
        Route::get('/product/picked-up/orders', 'Admin\ProductOrderController@pickedUp')->name('admin.pickedUp.product.orders');
        Route::get('/product/delivered/orders', 'Admin\ProductOrderController@delivered')->name('admin.delivered.product.orders');
        Route::get('/product/cancelled/orders', 'Admin\ProductOrderController@cancelled')->name('admin.cancelled.product.orders');
